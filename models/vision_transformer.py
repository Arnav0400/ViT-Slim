...
from .layers import ModuleInjection, Attention
...
class Block(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x + self.drop_path(self.mlp(self.norm2(x), z_patch))
        return x
...
class VisionTransformer(BaseModel):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='', head_search=False, uniform_search=False):
        """
        Args:
        ...
        self.blocks = nn.Sequential(*[
            Block(
                ...
                head_search=head_search, uniform_search=uniform_search)
    ...
    def get_flops(self):
        ...
        searched_flops = patch_embed_flops+blocks_flops_searched+head_flops
